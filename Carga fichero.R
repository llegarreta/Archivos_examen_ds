...
muestra03$genero_imp[str_detect(muestra03$NOMBRE, pattern = "O$|EL$|JULIO|JOSE|CARLOS|DAVID|MANUEL|PABLO|PEDRO|JUAN|LUIS|CESAR")] <- "M"
...
muestra03$genero_imp[str_detect(muestra03$NOMBRE, pattern = "A$|AR$|MARIA|ANA|ROSARIO|ROCIO")] <- "F"

# Muchos nombres vascos de chica acaban en NE
muestra03$genero_imp[str_detect(muestra03$NOMBRE, pattern = "NE$|EN$")] <- "F"

# Y los de chicos tienen tambien algunas terminaciones populares
muestra03$genero_imp[str_detect(muestra03$NOMBRE, pattern = "ON$|OSU$|AITZ$|IKA$|ER$|OR$")] <- "M"

length(muestra03$genero_imp)
sum(is.na(muestra03$genero_imp))

# Vemos que de 306085 entradas solo nos quedan sin imputar 58204, algo menos del 20%
